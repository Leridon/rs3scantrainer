...
export let clues: Clues.Step[] = [
    ...
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Crossing the desert I met a crocodile. She gave me a dazzling smile but she had something in her teeth.",
        "tier": "master",
        "id": 372,
        "solution": {
            "type": "simple",
            "spot": {"x": 3282, "y": 2676, "level": 0},
            "answer": "Catch a plover bird"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: I once met a man returning from market. He showed me the spoils of his day. It's precious to see what people pay for.",
        "tier": "master",
        "id": 373,
        "solution": {
            "type": "simple",
            "spot": {"x": 2670, "y": 3301, "level": 0},
            "answer": "Steal from the gem stall"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: A view of the city from high above. I can hear their prayers below.",
        "tier": "master",
        "id": 374,
        "solution": {
            "type": "simple",
            "spot": {"x": 2178, "y": 3403, "level": 0},
            "answer": "Complete the Hefin Agility Course."
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Round and round we go, burning, burning all aglow.",
        "tier": "master",
        "id": 375,
        "solution": {
            "type": "simple",
            "spot": {"x": 2947, "y": 2957, "level": 0},
            "answer": "Burn a curly root in the Jadinko lair"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: When I encountered this individual, she had more rings than any I had seen before.",
        "tier": "master",
        "id": 376,
        "solution": {
            "type": "simple",
            "spot": {"x": 3255, "y": 3375, "level": 0},
            "answer": "Cut some elder logs"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Rowdy Unruly Boisterous I am pie.",
        "tier": "master",
        "id": 377,
        "solution": {
            "type": "simple",
            "spot": {"x": 3165, "y": 3493, "level": 0},
            "answer": "Cook a Wild pie (can be done anywhere)"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: In a station of power someone requires assistance. Do a good deed to spread some happiness.",
        "tier": "master",
        "id": 378,
        "solution": {
            "type": "simple",
            "spot": {"x": 2722, "y": 5256, "level": 0},
    ...
    },
    {
        ...
        "solution": {
            "type": "simple",
            "spot": {"x": 3812, "y": 3557, "level": 0},
            "answer": "Harvest a radiant memory"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: There are those who prove themselves and become a beacon of light in the darkness. Come to the crystal city and become that figure.",
        "tier": "master",
        "id": 380,
        "solution": {
            "type": "simple",
            "spot": {"x": 2207, "y": 3362, "level": 0},
            "answer": "Activate Light Form prayer inside Prifddinas"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Stare into the flames for long enough and you may see something you didn't realise was there.",
        "tier": "master",
        "id": 381,
        "solution": {
            "type": "simple",
    ...
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: The crystals tempt most however, there are other riches to gain for the quick-fingered.",
        "tier": "master",
        "id": 382,
        "solution": {
            "type": "simple",
            "spot": {"x": 2186, "y": 3310, "level": 0},
            "answer": "Pickpocket any prifddinas worker"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Magical energy floats unleashed. The fluid of life that flows through us all. Span the gap to capture this energy.",
        "tier": "master",
        "id": 383,
        "solution": {
            "type": "simple",
            "spot": {"x": 3102, "y": 3157, "level": 0},
            "answer": "Siphon a blood esswraith, blood pool or bloody skulls in the Runespan"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: The spell struck me in the chest. Perhaps if I had worn armour today. Black looks better than red.",
        "tier": "master",
        "id": 384,
        "solution": {
            "type": "simple",
    ...
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Ernie once mentioned to me a secret to improve my cooking. His idea was strong but I went the extra mile.",
        "tier": "master",
        "id": 385,
        "solution": {
            "type": "simple",
    ...
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: I have all the ingredients for soup but sometimes a simple meal tastes the best.",
        "tier": "master",
        "id": 386,
        "solution": {
            "type": "simple",
    ...
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Take the journey to a distant mining site. Become a blight to your foes.",
        "tier": "master",
        "id": 387,
        "solution": {
            "type": "simple",
            "spot": {"x": 2975, "y": 3370, "level": 0},
            "answer": "Smelt a bane bar (can be done at any furnace)"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Where there is Light there is also Death. Should you contain this you may progress.",
        "tier": "master",
        "id": 388,
        "solution": {
            "type": "simple",
            "spot": {"x": 2543, "y": 3326, "level": 0},
            "answer": "Craft a death rune"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: There is a temple where there are rivers of red. Bind the magic to get ahead.",
        "tier": "master",
        "id": 389,
        "solution": {
            "type": "simple",
            "spot": {"x": 3643, "y": 3306, "level": 0},
            "answer": "Craft a Blood rune"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Corruption seeps from this stone but there are those who work to cleanse it. Lend your voice.",
        "tier": "master",
        "id": 390,
        "solution": {
            "type": "simple",
            "spot": {"x": 2190, "y": 3448, "level": 0},
            "answer": "Fully use a cleansing crystal on the corrupted seren stone"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Charm me and I shall unlock. But be brave in the darkness.",
        "tier": "master",
        "id": 391,
        "solution": {
            "type": "simple",
            "spot": {"x": 3377, "y": 3742, "level": 0},
            "answer": "Catch a charming moth"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: I once met an ancient warrior who told me tales of his adventures. His eyes lit up as he spoke.",
        "tier": "master",
        "id": 392,
        "solution": {
            "type": "simple",
            "spot": {"x": 3165, "y": 3492, "level": 0},
            "answer": "Burn some elder logs (can be done anywhere)"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Keeping all your gold together. That's a good idea. It shall be mine.",
        "tier": "master",
        "id": 393,
        "solution": {
            "type": "simple",
            "spot": {"x": 3060, "y": 3376, "level": 0},
            "answer": "Mine concentrated gold rocks in the Living Rock Caverns"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Rumours of a great shark continue to spread. Catch me one and I will be fed.",
        "tier": "master",
        "id": 394,
        "solution": {
            "type": "simple",
            "spot": {"x": 2853, "y": 3426, "level": 0},
    ...
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: The God of Order requires a sacrifice of strength but in return restores me. If only we could keep that feeling in his absence.",
        "tier": "master",
        "id": 395,
        "solution": {
            "type": "simple",
    ...
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Head protection is never a bad thing. Make it from rune for the best chance of survival.",
        "tier": "master",
        "id": 396,
        "solution": {
            "type": "simple",
            "spot": {"x": 3188, "y": 3427, "level": 0},
            "answer": "Smith a rune helm or full helm (can be done at any anvil)"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Being open to Chaos can raise your defences. It may also bring you closer to death. Take a moment to bottle this feeling.",
        "tier": "master",
        "id": 397,
        "solution": {
            "type": "simple",
            "spot": {"x": 3164, "y": 3493, "level": 0},
            "answer": "Mix a Zamorak brew (torstol+jangerberries, can be done anywhere)"
        }
    },
    {
        "type": "skilling",
        "text": "Complete the action to solve the clue: Catching only one shark. That don't impress me much.",
        "tier": "master",
        "id": 398,
        "solution": {
            "type": "simple",
            "spot": {"x": 2855, "y": 3433, "level": 0},
