...
let raw: ScanTree2.tree[] = [
    {
        ...
        "areas": [{
            "name": "A",
            "area": {"topleft": {"x": 2963, "y": 3380}, "botright": {"x": 2967, "y": 3376}}
        }, {
            "name": "B",
            "area": {"topleft": {"x": 2964, "y": 3366}, "botright": {"x": 2965, "y": 3365}}
        }, {
            "name": "C",
            "area": {"topleft": {"x": 2958, "y": 3365}, "botright": {"x": 2960, "y": 3363}}
        }, {
            "name": "D",
            "area": {"topleft": {"x": 2955, "y": 3365}, "botright": {"x": 2956, "y": 3363}}
        }, {
            "name": "E",
            "area": {"topleft": {"x": 2950, "y": 3365}, "botright": {"x": 2950, "y": 3363}}
        }, {
            "name": "F",
            "area": {"topleft": {"x": 3029, "y": 3341}, "botright": {"x": 3033, "y": 3338}}
        }, {
            "name": "G",
        ...
        "methods": [{"from": null, "to": "A", "short_instruction": "Falador teleport to {{target}}."}, {
            ...
            "from": "G",
            "to": [{"x": 3025, "y": 3379, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "G",
            "to": [{"x": 3059, "y": 3384, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "G",
            "to": [{"x": 3031, "y": 3379, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "F",
            ...
            "from": "B",
            "to": [{"x": 2938, "y": 3322, "level": 0}, {"x": 2976, "y": 3316, "level": 0}, {
                "x": 2947,
                "y": 3316,
                "level": 0
            }],
            "short_instruction": "Go to {{target}}"
        }, {"from": "A", "to": "B", "short_instruction": "{{surge}} to {{target}}."}, {
            "from": "B",
            "to": "C",
            "short_instruction": "Go to {{target}}."
        }, {
            "from": "C",
            "to": [{"x": 3015, "y": 3339, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {"from": "C", "to": "D", "short_instruction": "Go to {{target}}."}, {
            "from": "D",
            "to": [{"x": 3011, "y": 3382, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {"from": "D", "to": "E", "short_instruction": "Go to {{target}}."}, {
            "from": "E",
            "to": [{"x": 3005, "y": 3326, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "E",
            "to": [{"x": 2938, "y": 3322, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "B",
            "to": [{"x": 2972, "y": 3342, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "B",
            "to": [{"x": 2945, "y": 3339, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "B",
            "to": [{"x": 2939, "y": 3355, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "A",
            "to": [{"x": 2958, "y": 3379, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "A",
            "to": [{"x": 2948, "y": 3390, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "A",
            "to": [{"x": 2942, "y": 3388, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {"from": "A", "to": [{"x": 2939, "y": 3355, "level": 0}], "short_instruction": "Go to {{target}}"}],
        "root": {
            "where": "A",
            "why": "",
            "children": [{
                        ...
                        "value": {
                            ...
                            "children": [{
                                ...
                                "value": {
                                    "where": "D",
                                    "why": "",
                                    "children": [{"key": 1, "value": {"where": "E", "why": "", "children": []}}]
                                }
                            }]
                        }
                    }]
    ...
    ,
    {
        "type": "scantree",
        "clue": 351,
        "spot_ordering": [{"x": 3231, "y": 3439, "level": 0}, {"x": 3197, "y": 3423, "level": 0}, {
            "x": 3196,
            "y": 3415,
            "level": 0
        }, {"x": 3204, "y": 3409, "level": 0}, {"x": 3220, "y": 3407, "level": 0}, {
            "x": 3228,
            "y": 3409,
            "level": 0
        }, {"x": 3213, "y": 3462, "level": 0}, {"x": 3248, "y": 3454, "level": 0}, {
            "x": 3253,
            "y": 3393,
            "level": 0
        }, {"x": 3175, "y": 3415, "level": 0}, {"x": 3175, "y": 3404, "level": 0}, {
            "x": 3185,
            "y": 3472,
            "level": 0
        }, {"x": 3197, "y": 3383, "level": 0}, {"x": 3211, "y": 3385, "level": 0}, {
            "x": 3228,
            "y": 3383,
            "level": 0
        }, {"x": 3240, "y": 3383, "level": 0}, {"x": 3273, "y": 3398, "level": 0}, {
            "x": 3284,
            "y": 3378,
            "level": 0
        }, {"x": 3141, "y": 3488, "level": 0}, {"x": 3188, "y": 3488, "level": 0}, {
            "x": 3180,
            "y": 3510,
            "level": 0
        }, {"x": 3230, "y": 3494, "level": 0}, {"x": 3213, "y": 3484, "level": 0}, {"x": 3241, "y": 3480, "level": 0}],
        "assumes_meerkats": true,
        "areas": [{
            "name": "A",
            "area": {"topleft": {"x": 3213, "y": 3434}, "botright": {"x": 3214, "y": 3432}}
        }, {"name": "B", "area": {"topleft": {"x": 3223, "y": 3424}, "botright": {"x": 3224, "y": 3422}}}, {
            "name": "C",
            "area": {"topleft": {"x": 3233, "y": 3414}, "botright": {"x": 3234, "y": 3412}}
        }, {"name": "D", "area": {"topleft": {"x": 3242, "y": 3418}, "botright": {"x": 3244, "y": 3417}}}, {
            "name": "E",
            "area": {"topleft": {"x": 3254, "y": 3449}, "botright": {"x": 3254, "y": 3449}}
        }, {"name": "F", "area": {"topleft": {"x": 3244, "y": 3459}, "botright": {"x": 3244, "y": 3459}}}, {
            "name": "G",
            "area": {"topleft": {"x": 3179, "y": 3420}, "botright": {"x": 3183, "y": 3416}}
        }, {"name": "H", "area": {"topleft": {"x": 3162, "y": 3466}, "botright": {"x": 3163, "y": 3462}}}],
        "methods": [{"from": null, "to": "A", "short_instruction": "Varrock teleport to {{target}}."}, {
            "from": "A",
            "to": "B",
        ...
        }, {"from": "A", "to": "B", "short_instruction": "{{dive}} to {{target}}."}, {
            "from": "B",
            "to": "B",
            "short_instruction": "The spot is along the southern wall"
        }, {"from": "B", "to": "D", "short_instruction": "Go to {{target}}."}, {
            "from": "D",
            "to": "D",
            "short_instruction": "The spot is in the south-eastern area."
        }, {"from": "D", "to": "E", "short_instruction": "Go to {{target}}."}, {
            "from": "E",
            "to": "F",
            "short_instruction": "{{dive}} to {{target}}."
        }, {"from": "E", "to": "H", "short_instruction": "Grand Exchange teleport to {{target}}."}, {
            "from": "H",
            "to": "H",
            "short_instruction": "It's either 19 or 20."
        }, {"from": "H", "to": "H", "short_instruction": "It's either 21 or 22."}],
        "root": {
            "where": "A",
            "why": "",
            "children": [{
                ...
                "value": {
                    "where": "B",
                    "why": "",
                    "children": [{"key": 1, "value": {"where": "C", "why": "", "children": []}}, {
                        "key": 0,
                        "value": {"where": "G", "why": "", "children": []}
                    }]
                }
            }, {
                "key": 0,
                                ...
                                "value": {
                                    ...
                                    "children": [{
                                        ...
                                        "value": {
                                            ...
                                            "children": [{
                                                "key": 1,
                                                "value": {"where": "H", "why": "", "children": []}
                                            }, {"key": 0, "value": {"where": "H", "why": "", "children": []}}]
                                        }
                                    }]
                                }
                            }]
    ...
    ,
    {
        "type": "scantree",
        "clue": 352,
        "spot_ordering": [{"x": 2662, "y": 3304, "level": 0}, {"x": 2635, "y": 3313, "level": 0}, {
            "x": 2623,
            "y": 3311,
            "level": 0
        }, {"x": 2625, "y": 3292, "level": 0}, {"x": 2662, "y": 3338, "level": 0}, {
            "x": 2633,
            "y": 3339,
            "level": 0
        }, {"x": 2613, "y": 3337, "level": 0}, {"x": 2537, "y": 3306, "level": 0}, {
            "x": 2540,
            "y": 3331,
            "level": 0
        }, {"x": 2520, "y": 3318, "level": 0}, {"x": 2517, "y": 3281, "level": 0}, {
            "x": 2509,
            "y": 3330,
            "level": 0
        }, {"x": 2500, "y": 3290, "level": 0}, {"x": 2496, "y": 3282, "level": 0}, {
            "x": 2512,
            "y": 3267,
            "level": 0
        }, {"x": 2529, "y": 3270, "level": 0}, {"x": 2569, "y": 3340, "level": 0}, {
            "x": 2570,
            "y": 3321,
            "level": 0
        }, {"x": 2582, "y": 3314, "level": 0}, {"x": 2583, "y": 3265, "level": 0}, {
            "x": 2589,
            "y": 3330,
            "level": 0
        }, {"x": 2589, "y": 3319, "level": 0}, {"x": 2483, "y": 3313, "level": 0}, {
            "x": 2475,
            "y": 3331,
            "level": 0
        }, {"x": 2467, "y": 3319, "level": 0}, {"x": 2462, "y": 3282, "level": 0}, {
            "x": 2442,
            "y": 3310,
            "level": 0
        ...
        "areas": [{
            "name": "A",
            "area": {"topleft": {"x": 2659, "y": 3306}, "botright": {"x": 2665, "y": 3300}}
        }, {"name": "B", "area": {"topleft": {"x": 2648, "y": 3308}, "botright": {"x": 2650, "y": 3306}}}, {
            "name": "C",
            "area": {"topleft": {"x": 2538, "y": 3306}, "botright": {"x": 2538, "y": 3306}}
        }, {"name": "D", "area": {"topleft": {"x": 2531, "y": 3303}, "botright": {"x": 2531, "y": 3303}}}, {
            "name": "E",
            "area": {"topleft": {"x": 2521, "y": 3293}, "botright": {"x": 2521, "y": 3293}}
        }],
        "methods": [{"from": null, "to": "A", "short_instruction": "Ardounge teleport to {{target}}."}, {
            "from": "A",
            "to": "C",
            "short_instruction": "Dave's spellbook to {{target}}."
        }, {
            "from": "C",
            "to": [{"x": 2442, "y": 3310, "level": 0}, {"x": 2440, "y": 3319, "level": 0}, {
                "x": 2462,
                "y": 3282,
                "level": 0
            }, {"x": 2483, "y": 3313, "level": 0}, {"x": 2467, "y": 3319, "level": 0}, {
                "x": 2475,
                "y": 3331,
                "level": 0
            }],
            "short_instruction": "Go to {{target}}"
        }, {"from": "C", "to": "D", "short_instruction": "Step/{{dive}} to {{target}}"}, {
            "from": "D",
            "to": [{"x": 2589, "y": 3319, "level": 0}, {"x": 2589, "y": 3330, "level": 0}],
            "short_instruction": "Use the manhole"
        }, {"from": "D", "to": "E", "short_instruction": "{{surge}} to {{target}}."}, {
            "from": "E",
            "to": "C",
            "short_instruction": "Teleport back to {{target}} and use the gate"
        }, {
            "from": "C",
            "to": [{"x": 2583, "y": 3265, "level": 0}, {"x": 2582, "y": 3314, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {"from": "E", "to": "E", "short_instruction": "Go through the manhole"}, {
            "from": "E",
            "to": [{"x": 2570, "y": 3321, "level": 0}, {"x": 2569, "y": 3340, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "E",
            "to": [{"x": 2496, "y": 3282, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "E",
            "to": [{"x": 2512, "y": 3267, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "E",
            "to": [{"x": 2529, "y": 3270, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "E",
            "to": [{"x": 2500, "y": 3290, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "D",
            "to": [{"x": 2509, "y": 3330, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "C",
            "to": [{"x": 2517, "y": 3281, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "C",
            "to": [{"x": 2537, "y": 3306, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "C",
            "to": [{"x": 2520, "y": 3318, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {
            "from": "C",
            "to": [{"x": 2540, "y": 3331, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {"from": "A", "to": "B", "short_instruction": "{{dive}} to {{target}}."}, {
            "from": "B",
            "to": "B",
            "short_instruction": "Teleport to {{target}} lodestone"
        }, {
            "from": "B",
            "to": [{"x": 2662, "y": 3338, "level": 0}, {"x": 2633, "y": 3339, "level": 0}, {
                "x": 2613,
                "y": 3337,
                "level": 0
            }],
            ...
            "from": "A",
            "to": [{"x": 2662, "y": 3304, "level": 0}],
            "short_instruction": "Go to {{target}}"
        }, {"from": "A", "to": [{"x": 2635, "y": 3313, "level": 0}], "short_instruction": "Go to {{target}}"}],
        "root": {
            "where": "A",
            "why": "",
            "children": [{
                            ...
                            "children": [{
                                ...
                                "value": {
                                    ...
                                    "children": [{
                                        "key": 1,
                                        "value": {"where": "E", "why": "", "children": []}
                                    }, {"key": 0, "value": {"where": "C", "why": "", "children": []}}]
                                }
                            }]
                        }
                    }]
