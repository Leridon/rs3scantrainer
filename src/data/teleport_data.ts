    ...
    export const raw_data: teleport_group[] = [
        {
            ...
            spots: [
                ...
                {id: "soul", spot: {x: 3087, y: 2697, level: 0}, code: "Soul"},
                {id: "cosmic", spot: {x: 2408, y: 4379, level: 0}, code: "Cosmic"},
                {id: "air", spot: {x: 3127, y: 3403, level: 0}, code: "Air"},
                {id: "body", spot: {x: 3053, y: 3443, level: 0}, code: "Body"},
                {id: "mind", spot: {x: 2982, y: 3514, level: 0}, code: "Mind"},
                {id: "fire", spot: {x: 3314, y: 3256, level: 0}, code: "Fire"},
                {id: "earth", spot: {x: 3305, y: 3475, level: 0}, code: "Earth"},
                {id: "water", spot: {x: 3165, y: 3185, level: 0}, code: "Water"},
                {id: "nature", spot: {x: 2870, y: 3023, level: 0}, code: "Nature"},
                {id: "astral", spot: {x: 2158, y: 3866, level: 0}, code: "Astral"},
                {id: "chaos", spot: {x: 3059, y: 3593, level: 0}, code: "Chaos"},
                {id: "law", spot: {x: 2857, y: 3382, level: 0}, code: "Law"},
