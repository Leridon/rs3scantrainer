...
export namespace teleport_data {
    ...
    export const raw_data: teleport_group[] = [
        ...
        {
            id: "ringofkinship", name: "Ring of Kinship", img: "ringofkinship.png", spots: [{
        ...
        {
            id: "ecctophial", name: "Ectophial", img: "ectophial.png", spots: [{
