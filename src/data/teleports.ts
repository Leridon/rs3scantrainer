...
const raw: teleport_group[] = [{
    ...
    img: "",
    spots: [
        {subid: "grandexchange", spot: {x: 3160, y: 3458}, img: "scroll-grandexchange.png", hover: "Grand Exchange", code: "1"},
        ...
        {subid: "fortforinthry", spot: {x: 3302, y: 3550}, img: "scroll-fortforinthry.png", hover: "Forintry Teleport", code: "6"},
        {subid: "miscellania", spot: {x: 2514, y: 3862}, img: "scroll-miscellania.png", hover: "Miscellania", code: "7"},
        {subid: "phoenixlair", spot: {x: 2293, y: 3620}, img: "scroll-phoenixlair.png", hover: "Phoenix Lair", code: "8"},
        {subid: "pollnivneach", spot: {x: 3360, y: 2966}, img: "scroll-pollnivneach.png", hover: "Pollnivneach", code: "9"},
        {subid: "tabwowannai", spot: {x: 2801, y: 3085}, img: "scroll-taibwowannai.png", hover: "Tai Bwo Wannai", code: "0"},
    ...
    spots: [
        ...
        {subid: "outpost", spot: {x: 2552, y: 3474}, code: "4", hover: "Dwarven Outpost (Requires Dark Facet of Luck unlocked)"},
    ]
}, {
    ...
    {id: "ringofkinship", name: "Ring of Kinship", img: "ringofkinship.png", spots: [{spot: {x: 3449, y: 3701}}]},
    {
        ...
        spots: [{spot: {x: 2950, y: 2933}, hover: "Herblore Habitat"}]
    },
    {id: "exctophial", name: "Ectophial", img: "ectophial.png", spots: [{spot: {x: 3660, y: 3521}}]},
    {
        ...
        spots: [{spot: {x: 3053, y: 3290}, hover: "Cabbage field"}]
    },
    ...
    {id: "theheart", name: "The Heart teleport", img: "theheart.gif", spots: [{spot: {x: 3199, y: 6942}}]},
    {
        ...
        spots: [{spot: {x: 2642, y: 3678}, hover: "Relekka Market"}]
    },
    ...
    {id: "archjounal", name: "Archaeology journal", img: "archjournal.png", spots: [{spot: {x: 3334, y: 3379}}]},
    {
        ...
        spots: [{spot: {x: 3081, y: 3422}, code: "1", hover: "Outside"}]
    },
    {
        id: "dragonkinlaboratory",
        name: "Dragonking Laboratory teleport",
        img: "dragonkin.png",
        spots: [{spot: {x: 3368, y: 3887}}]
    },
    {
