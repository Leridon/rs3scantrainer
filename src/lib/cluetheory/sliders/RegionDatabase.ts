...
export namespace RegionDistanceDatabase {
  ...
  export function generate(description: RegionDatabaseDescription): Process<RegionDistanceDatabase> {

    return (new class extends Process<RegionDistanceDatabase> {
      async implementation(): Promise<RegionDistanceDatabase> {
