...
import {floor_t, MapCoordinate} from "../runescape/coordinates";
...
import {control, Control, MapOptions} from "leaflet";
...
import FloorControlLayer from "./defaultlayers/FloorControl";
...
export class GameMap extends leaflet.Map {
    ...
    constructor(element: HTMLElement) {
        ...
        this.addGameLayer(new FloorControlLayer())
    ...
    public override addControl(control: leaflet.Control | GameMapControl): this {
        ...
        if(!(control instanceof GameMapControl)) {
            ...
            control.appendTo(getPositionLayer(control.options.position))
