...
const teles: teleport_item[] = [
    {
        ...
        spots: [
            ...
            {spot: {x: 3087, y: 2697}, hover: "Soul"},
            {spot: {x: 2408, y: 4379}, hover: "Cosmic"},
            {spot: {x: 3127, y: 3403}, hover: "Air"},
            {spot: {x: 3053, y: 3443}, hover: "Body"},
            {spot: {x: 2982, y: 3514}, hover: "Mind"},
            {spot: {x: 3314, y: 3256}, hover: "Fire"},
            {spot: {x: 3305, y: 3475}, hover: "Earth"},
            {spot: {x: 3165, y: 3185}, hover: "Water"},
            {spot: {x: 2870, y: 3023}, hover: "Nature"},
            {spot: {x: 2158, y: 3866}, hover: "Astral"},
            {spot: {x: 3059, y: 3593}, hover: "Chaos"},
            {spot: {x: 2857, y: 3382}, hover: "Law"},
    ...
    {id: "dragonkinlaboratory", name: "Dragonking Laboratory teleport", img: "dragonkin.png", spots: [{spot: {x: 3368, y: 3887}}]},
    {
        ...
        spots: [
            {spot: {x: 3156, y: 3620}, code: "1"},
            {spot: {x: 3219, y: 3656}, code: "2"},
            {spot: {x: 3035, y: 3732}, code: "3"},
            {spot: {x: 3106, y: 3794}, code: "4"},
            {spot: {x: 2980, y: 3866}, code: "5"},
            {spot: {x: 3307, y: 3916}, code: "6"},
        ]
    }, {
                ...
                if (!spot.has_variants) {
                    ...
                    leaflet.marker([s.y, s.x], {
                        icon: new TeleportIcon({
                            iconUrl: `./img/icons/teleports/${img}`,
                            text: spot.code,
                            title: tooltip
                        })
                    }).addTo(this)
