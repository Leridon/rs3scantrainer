    ...
    if (true || is_first_visit && this.in_alt1) {
      (new class extends NisModal {
        ...
        render() {
          ...
          const layout = new Properties().appendTo(this.body)
          layout.paragraph("You have successfully installed Clue Trainer! If you want, check out the video tutorial made by <b>Ngis</b> embedded below. For additional info, open the 'About' page linked in the left sidebar.")
