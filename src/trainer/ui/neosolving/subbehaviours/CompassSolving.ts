...
export namespace CompassSolving {
  ...
  export const teleport_hovers: {
    ...
    [
      ...
      {expected: "Quick teleport Draynor", teleport_id: {group: "home", spot: "draynor"}},
      {expected: "Teleport Draynor", teleport_id: {group: "home", spot: "draynor"}},
      ...
      {expected: "Quick teleport Fremennik", teleport_id: {group: "home", spot: "fremmenik"}},
      {expected: "Teleport Fremennik", teleport_id: {group: "home", spot: "fremmenik"}},
      ...
      {expected: "Quick teleport Wilderness", teleport_id: {group: "home", spot: "wilderness"}},
      {expected: "Teleport Wilderness", teleport_id: {group: "home", spot: "wilderness"}},
